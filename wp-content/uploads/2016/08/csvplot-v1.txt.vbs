...
'    Dim r As Range
'    Set r = Excel.ActiveSheet.Columns(1)
'    Dim r2 As Range
'    Set r2 = r.Rows(1)
'    MsgBox r2.Address
...
'    Set column = xlApp.ActiveSheet.Columns(columnIndex)
'    Dim rangeStart As Range
'    Set rangeStart = firstColumn.Rows(2) 'first is title
'    Dim rangeEnd As Range
'    Set rangeEnd = firstColumn.End(xlDown) 'last element of the column
'    MsgBox rangeStart.Address
'    MsgBox rangeEnd.Address
'    
'    Dim final As Range
'    Set final = Range(rangeStart, rangeEnd)
'    MsgBox final.Address
