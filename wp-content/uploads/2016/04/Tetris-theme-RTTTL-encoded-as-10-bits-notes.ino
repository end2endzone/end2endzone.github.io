//Notes:
// 10 Bits RTTTL format requires AnyRtttl & BitReader libraries.
// The code & updates for AnyRtttl & BitReader libraries can be found on http://end2endzone.com
#include <anyrtttl.h>
#include <binrtttl.h>
#include <pitches.h>
...
const unsigned char tetris[] = {0x0A, 0x14, 0x12, 0xCE, 0x34, 0xE0, 0x82, 0x14, 0x32, 0x38, 0xE0, 0x4C, 0x2A, 0xAD, 0x34, 0xA0, 0x84, 0x0B, 0x0E, 0x28, 0xD3, 0x4C, 0x03, 0x2A, 0x28, 0xA1, 0x80, 0x2A, 0xA5, 0xB4, 0x93, 0x82, 0x1B, 0xAA, 0x38, 0xE2, 0x86, 0x12, 0x4E, 0x38, 0xA0, 0x84, 0x0B, 0x0E, 0x28, 0xD3, 0x4C, 0x03, 0x2A, 0x28, 0xA1, 0x80, 0x2A, 0xA9, 0x04};
...
//the following function reads numBits from the tetris buffer
...
//bitreader.setBuffer(tetris);

//Call the following for playing tetris melody
//anyrtttl::blocking::play10Bits(BUZZER_PIN, tetris_length, &readNextBits);
